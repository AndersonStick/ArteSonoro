...
class GetItemsView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al recuperar los elementos de la lista de deseos'},
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if WishListItem.objects.filter(wishlist=wishlist, product=product).exists():
                return Response(
                    {'error': 'Elemento ya está en la lista de deseos'},
            ...
            return Response(
                {'error': 'Algo salió mal al agregar el artículo a la lista de deseos'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
class GetItemTotalView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al recuperar el número total de artículos en la lista de deseos'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
class RemoveItemView(APIView):
    def delete(self, request, format=None):
        ...
        try:
            ...
            if not Product.objects.filter(id=product_id).exists():
                return Response(
                    {'error': 'Producto con este ID no existe'},
                    status=status.HTTP_404_NOT_FOUND
                )
            product = Product.objects.get(id=product_id)
            ...
            return Response(
                {'error': 'Algo salió mal al quitar el elemento de la lista de deseos'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )