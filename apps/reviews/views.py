...
class GetProductReviewsView(APIView):
    ...
    def get(self, request, productId, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al recuperar las reseñas'},
...
class CreateProductReviewView(APIView):
    def post(self, request, productId, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Debe incluir un comentario al crear una reseña'},
                status=status.HTTP_400_BAD_REQUEST
            )
        ...
        try:
            ...
            if Review.objects.filter(user=user, product=product).exists():
                return Response(
                    {'error': 'La reseña para este producto ya ha sido creada'},
...
class UpdateProductReviewView(APIView):
    def put(self, request, productId, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Debe proporcionar un comentario al crear una reseña'},
                status=status.HTTP_400_BAD_REQUEST
            )
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al actualizar la reseña'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
class FilterProductReviewsView(APIView):
    ...
    def get(self, request, productId, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Algo salió mal al filtrar las reseñas del producto'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )