    ...
    return (
              ...
              <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                ...
                >
                  <div className="absolute top-0 right-0 -mr-12 pt-2">
                    ...
                    >
                      <span className="sr-only">Cerrar la barra lateral</span>
        ...
        <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
          ...
          <div className="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-white overflow-y-auto">
            ...
            <Link
                to="/"
                className="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom-blue"
            >
                Regresar
            </Link>
        ...
        <div className="mt-8">
          ...
          <div className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
            ...
            <div className="mt-4 sm:mt-0">
              <Link to={`/dashboard/payment/${product.transaction_id}`} className="font-medium text-custom-blue hover:text-custom-hover-blue">
              ...
              >
                ...
                <div className="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
                  ...
                  <p className="font-medium text-gray-900 mt-1">ID de transacción: {product.transaction_id}</p>
